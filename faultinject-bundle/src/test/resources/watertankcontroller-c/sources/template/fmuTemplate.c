...
fmi2Status fmi2SetDebugLogging(fmi2Component c, fmi2Boolean loggingOn, size_t nCategories, const fmi2String categories[]) {
  ...
  /*  if (isCategoryLogged(comp, 2))
    {
    	comp->functions->logger(NULL,NULL,fmi2OK,NULL,NULL);
            comp->functions->logger(comp->functions->componentEnvironment, comp->instanceName, fmi2OK, logCategoriesNames[2], "fmi2SetDebugLogging");
    }*/
...
//            stateEvent = 0;
//        }
fmi2Status internalStatus=	fmi2DoStepInternal(comp, currentCommunicationPoint, communicationStepSize, noSetFMUStatePriorToCurrentPoint);

if (internalStatus != fmi2OK)
{
